...
import 'package:edge_ai/chat_screen.dart';
import 'package:edge_ai/embedding_test_screen.dart';
import 'package:edge_ai/models/base_model.dart';
import 'package:edge_ai/models/model.dart';
import 'package:edge_ai/models/embedding_model.dart' as example_embedding_model;
import 'package:edge_ai/services/model_download_service.dart';
    ...
    try {
      if (widget.model.isEmbeddingModel) {
        await _embeddingDownloadService!.downloadModel(
            widget.model.needsAuth ? _token : '', (modelProg, tokenizerProg) {
          setState(() {
