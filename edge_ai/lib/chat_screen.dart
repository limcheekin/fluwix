...
import 'package:edge_ai/chat_widget.dart';
import 'package:edge_ai/loading_widget.dart';
import 'package:edge_ai/models/model.dart';
import 'package:edge_ai/model_selection_screen.dart';
import 'package:edge_ai/services/auth_token_service.dart';

class ChatScreen extends StatefulWidget {
  const ChatScreen(
      {super.key, this.model = Model.gemma3_1B, this.selectedBackend});
