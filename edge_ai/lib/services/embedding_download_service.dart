...
import 'package:edge_ai/models/base_model.dart'; // For ModelSourceType
...
class EmbeddingModelDownloadService {
  ...
  Future<bool> checkModelExistence(String token) async {
    try {
      ...
      final tokenizerFilename =
          extractFilename(model.tokenizerUrl, model.sourceType);
  ...
  Future<bool> isEmbeddingModelInstalled() async {
    try {
      ...
      final tokenizerInstalled =
          await FlutterGemma.isModelInstalled(model.tokenizerFilename);
