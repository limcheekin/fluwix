...
import 'package:edge_ai/services/auth_token_service.dart';
import 'package:edge_ai/cosine_similarity_screen.dart';
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed:
                _embeddingModel != null ? _navigateToCosineSimilarity : null,
          ),
        ],
      ),
                ...
                Expanded(
                  child: ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      backgroundColor:
                          _isGenerating ? Colors.grey : const Color(0xFF1a4a7c),
