...
import 'package:edge_ai/chat_input_field.dart';
import 'package:edge_ai/chat_message.dart';
import 'package:edge_ai/gemma_input_field.dart';
import 'package:edge_ai/thinking_widget.dart';
              ...
              onThinkingCompleted: (String thinkingContent) {
                ...
                if (thinkingContent.isNotEmpty) {
                  ...
                  final thinkingMessage =
                      Message.thinking(text: thinkingContent);
                  widget.messageHandler(
                      thinkingMessage); // Add to history through message handler
