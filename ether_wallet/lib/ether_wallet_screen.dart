...
class EtherWalletScreen extends StatelessWidget {
  const EtherWalletScreen({Key? key}) : super(key: key);
  ...
  static const branch = 'ether_wallet';

  @override
  Widget build(BuildContext context) {
    return const ShowcaseView(
      title: 'Ether Wallet',
      widget: EtherWalletWidget(),
      owner: owner,
      ...
      codePaths: [
        '$branch/pubspec.yaml',
        '$branch/lib/ether_wallet_screen.dart',
      ],
    );
  }
}

class EtherWalletWidget extends StatelessWidget {
  const EtherWalletWidget({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return const Text('Replace this with your Ether Wallet widget');
  }
}
