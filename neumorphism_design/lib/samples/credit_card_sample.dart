...
class CreditCardSample extends StatefulWidget {
  ...
  @override
  State<CreditCardSample> createState() => _CreditCardSampleState();
}
        ...
        child: SizedBox(
          ...
          child: AspectRatio(
            ...
            child: Stack(
              fit: StackFit.expand,
              children: <Widget>[
                //Image.asset('packages/neumorphism_design/assets/images/map.jpg', fit: BoxFit.cover),
                BackdropFilter(
                      ...
                      child: SizedBox(
                        ...
                        child: Neumorphic(
                          ...
                          child: RotatedBox(
                              quarterTurns: 1,
                              child: Image.asset(
                                  'packages/neumorphism_design/assets/images/credit_card_chip.png')),
                        ),
                      ),
                    ),
                    Positioned(
      ...
      children: <Widget>[
        SizedBox(
          ...
          child: NeumorphicRadio(
            ...
            onChanged: (value) {
              setState(() {
                _dotIndex = int.tryParse(value.toString());
              });
            },
